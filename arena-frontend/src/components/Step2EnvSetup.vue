                ...
                >
                  ...
                  <div class="agent-card-header">
                    <div class="agent-identity">
                      <span class="agent-id">{{ $t('step2.thinkerLabel') }} {{ agent.agent_id }}</span>
                  ...
                  <div class="timeline-content">
                    <div class="post-header">
                      ...
                      <span class="post-agent-info">
                        <span class="post-id">{{ $t('step2.thinkerLabel') }} {{ post.poster_agent_id }}</span>
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (currentCount > 0 && currentCount !== lastLoggedProfileCount) {
        ...
        const profileName = latestProfile?.name || latestProfile?.username || `${t('step2.thinkerLabel')}_${currentCount}`
        if (currentCount === 1) {
...
.step-card {
  ...
  transition: border-color var(--duration-slow) var(--ease-out), box-shadow var(--duration-slow) var(--ease-out), transform var(--duration-fast) var(--ease-out);
  position: relative;
}
...
.profile-card {
  ...
  padding: 14px;
  cursor: pointer;
  transition: background var(--duration-normal) var(--ease-out), border-color var(--duration-normal) var(--ease-out), transform var(--duration-fast) var(--ease-out);
}
...
.narrative-box {
  ...
  transition: box-shadow var(--duration-slow) var(--ease-out), border-color var(--duration-slow) var(--ease-out), transform var(--duration-fast) var(--ease-out);
}
...
.switch-track {
  ...
  border-radius: 10px;
  position: relative;
  transition: background 0.3s cubic-bezier(0.4, 0.0, 0.2, 1), transform var(--duration-fast) var(--ease-out);
}
