    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <h1 class="main-title">
            跨学科辩证<br>
            <span class="gradient-text">思想沙盒</span>
          </h1>

          <div class="hero-desc">
            <p>
              <span class="highlight-bold">Superintell Arena</span> 基于
              <span class="highlight-orange">100-1000+</span> 位真实企业家、经济学家、思想家的知识图谱，
              通过 <span class="highlight-code">辩证模拟</span> 产出前所未有的跨学科洞察和预测
            </p>
            <p class="slogan-text">
              突破狭义思维陷阱<span class="blinking-cursor">_</span>
            </p>
          </div>
...
.scroll-down-btn {
  ...
  color: var(--orange);
  font-size: 1.2rem;
  transition: border-color var(--duration-normal) var(--ease-out), transform var(--duration-fast) var(--ease-out);
}
...
.start-engine-btn {
  ...
  align-items: center;
  cursor: pointer;
  transition: background var(--duration-slow) var(--ease-out), border-color var(--duration-slow) var(--ease-out), transform var(--duration-fast) var(--ease-out), opacity var(--duration-slow) var(--ease-out);
  letter-spacing: 1px;
  position: relative;
  overflow: hidden;
}
