...
class Config:
    ...
    # LLM配置（通过 LiteLLM 支持多提供商：openai、anthropic、deepseek 等）
    ...
    LLM_BOOST_BASE_URL = os.environ.get('LLM_BOOST_BASE_URL', None)
    LLM_BOOST_MODEL_NAME = os.environ.get('LLM_BOOST_MODEL_NAME', None)
